...
require_relative 'controllers/carriage_action_selection_controller'
require_relative 'controllers/carriage_space_value_input_dialog'
require_relative 'controllers/carriage_to_take_space_selection_controller'
require_relative 'controllers/carriages_in_train_controller'
require_relative 'controllers/train_carriages_list_controller'
require_relative 'controllers/existing_trains_selection_controller'
require_relative 'controllers/main_screen_controller'
require_relative 'controllers/new_carriage_creation_dialog_controller'
...
require_relative 'controllers/train_to_add_carriage_selection_controller'
require_relative 'controllers/train_to_remove_carriage_selection_controller'
